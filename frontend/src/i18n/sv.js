export default {
  ...
  travelTinder: {
    ...
    // C33 / FAS 7a — manuell upload-card
    upload: {
      title: 'Ladda upp fysiskt kvitto',
      titleForSelected: 'Ladda upp kvitto för denna korttrans',
      dropHint: 'Släpp filen här eller klicka för att välja',
      chooseFile: 'Välj fil',
      accept: 'PDF, JPG eller PNG (max 50 MB)',
      methodLabel: 'Betalningsmetod',
      companyCard: 'Företagskort',
      privateCard: 'Privat kort',
      privateCardComingSoon: 'Kommer i FAS 7b (Netvisor-integration)',
      commentLabel: 'Kommentar (valfritt)',
      commentPlaceholder: 'T.ex. "Biltvätt 12 maj"',
      uploadBtn: 'Ladda upp och koppla',
      uploadBtnNoCouple: 'Ladda upp',
      uploading: 'Laddar upp och analyserar…',
      successCoupled: '✓ Uppladdat och kopplat till {vendor}',
      success: '✓ Kvitto uppladdat',
      errorGeneric: 'Uppladdning misslyckades',
      errorTooLarge: 'Filen är för stor — max 50 MB',
      errorWrongType: 'Endast PDF, JPG eller PNG',
